...
import { AuditInterceptor } from 'src/core/http/interceptors/audit.interceptor';
...
/**
 * @deprecated Use Audit() instead — it auto-applies the AuditInterceptor.
 * AuditMeta only sets metadata without binding the interceptor,
 * which can silently cause audit logs to not be recorded.
 */
export const AuditMeta = Audit;
