...
const { columns, columnChecks, data, getData, getDataByPage, loading, mobilePagination, searchParams } = useTable({
  immediate: false,
  apiFn: fetchDictFindAllData as NaiveUI.TableApiFn<Api.System.DictData>,
  apiParams: {
    pageNum: 1,
    pageSize: 10,
    ...
    <div class="flex-center gap-12px">
      <ButtonIcon
        ...
        onClick={(event: Event) => {
          ...
          handleEditType(option as unknown as Api.System.DictType);
        }}
      />
      <ButtonIcon
        text
        ...
        onPositiveClick={() => handleDeleteType(option as unknown as Api.System.DictType)}
      />
    </div>
  );
}
    ...
    <div class="h-full flex-col-stretch gap-12px overflow-hidden lt-sm:overflow-auto">
      ...
      <NCard :title="() => tableTitle" :bordered="false" size="small" class="card-wrapper sm:flex-1-hidden">
        ...
        <DictDataOperateDrawer
          ...
          :row-data="editingData as Api.System.DictData | null"
