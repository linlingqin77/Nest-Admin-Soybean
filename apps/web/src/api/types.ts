 ...
 * Generated at: 2026-08-31T03:40:43.881Z
 */
...
/** 数据权限范围枚举 - DATA_SCOPE_ALL (1): 全部数据权限 - DATA_SCOPE_CUSTOM (2): 自定数据权限 - DATA_SCOPE_DEPT (3): 本部门数据权限 - DATA_SCOPE_DEPT_AND_CHILD (4): 本部门及以下数据权限 - DATA_SCOPE_SELF (5): 仅本人数据权限 */
...
/** 设备类型枚举 - PC (pc): PC端 - APP (app): 移动端 - MINI (mini): 小程序 - SOCIAL (social): 社交登录 */
...
/** 通知公告类型枚举 - NOTICE (1): 通知 - ANNOUNCEMENT (2): 公告 */
...
/** 性别枚举 - MAN (0): 男 - WOMAN (1): 女 - UNKNOWN (2): 未知 */
...
/** 数据状态枚举 - NORMAL (0): 正常/启用 - STOP (1): 停用/禁用 */
