...
const columns: NaiveUI.TableColumn<Api.Tool.GenTableColumn>[] = [
  ...
  },
  {
    ...
    align: 'center',
    width: 64,
    render: (row) => <NCheckbox checked-value="YES" unchecked-value="NO" v-model:checked={row.isInsert} />,
  },
  {
    key: 'isEdit',
    title: '编辑',
    align: 'center',
    width: 64,
    render: (row) => <NCheckbox checked-value="YES" unchecked-value="NO" v-model:checked={row.isEdit} />,
  },
  {
    key: 'isList',
    title: '列表',
    align: 'center',
    width: 64,
    render: (row) => <NCheckbox checked-value="YES" unchecked-value="NO" v-model:checked={row.isList} />,
  },
  {
    key: 'isQuery',
    title: '查询',
    align: 'center',
    width: 64,
    render: (row) => <NCheckbox checked-value="YES" unchecked-value="NO" v-model:checked={row.isQuery} />,
  },
  {
    key: 'queryType',
    title: '查询方式',
  ...
  },
  {
    ...
    align: 'center',
    width: 64,
    render: (row) => <NCheckbox checked-value="YES" unchecked-value="NO" v-model:checked={row.isRequired} />,
  },
  {
    key: 'htmlType',
    title: '显示类型',
